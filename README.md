...
| **안민제 (Frontend Developer)**<br>[@minje0209-ux](https://github.com/minje0209-ux) | • Vanilla JS 기반 동적 렌더링 최적화<br>• Plotly 활용 금융 데이터 시각화<br>• 글로벌 테마(Dark/Light) 스위처 시스템<br>• UI/UX 인터페이스 설계 및 고도화 | • Django 기반 아키텍쳐 위에 비즈니스 타겟을 고려한 프론트엔드 UX 설계를 고민하는 과정이 좋았습니다. |
